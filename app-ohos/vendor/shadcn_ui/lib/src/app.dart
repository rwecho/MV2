    ...
    switch (axisDirectionToAxis(details.direction)) {
      ...
      case Axis.vertical:
        switch (getPlatform(context)) {
          ...
          // MV2 ohos patch: the HarmonyOS Flutter fork adds TargetPlatform.ohos,
          // which makes every exhaustive switch over TargetPlatform a compile
          // error. Treat ohos like android (platform-provided scrollbar).
